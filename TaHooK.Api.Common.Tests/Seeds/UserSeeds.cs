...
public static class UserSeeds
{
    ...
    public static readonly UserEntity UserToDelete = DefaultUser with
    {
        Id = Guid.Parse("8C43E708-44CA-4D7A-9F76-5D2A2155BF02")
    };

    public static readonly UserEntity UserToUpdate = DefaultUser with
    {
        Id = Guid.Parse("267FA2C2-D406-4E22-9AA9-4EC927E6F1CF")
    };
